...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'locale' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'event_type_id' => 1,
                'created' => '2018-06-26 08:56:41',
                'modified' => '2018-06-26 08:56:41'
            ],
        ];
        parent::init();
    }
